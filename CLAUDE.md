...
- **Design doc**: [`FACILITATOR.md`](https://github.com/HorizenOfficial/vela/blob/main/docs/design/FACILITATOR.md) (section 5.3 for this service)
...
- x402 routes: `GET /supported`, `POST /verify`, `POST /settle`
- Core route: `POST /submit` (nonce queries are done directly on-chain by clients)
